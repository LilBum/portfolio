...
export const experience: Experience[] = [
  {
    ...
    bullets: [
      ...
      'Modernized a 10+ year-old Java/Struts application into Angular front ends and Spring Boot/Hibernate services, preserving 10,000+ existing unit tests.',
      'Hold 98% Jest coverage on the front-end modules I own.',
